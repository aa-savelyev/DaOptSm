...
Здесь:
\begin{itemize}
  \item \(x_i\) --- независимая (входная) переменная выборки \(i\), с
  \(x = \{x_i \ldots x_m \}\);
  \item  \(y_i\) --- зависимая (выходная)
  переменная выборки \(i\), с \(y = \{y_i \ldots y_m \}\);
  \item \(\epsilon_i \sim \mathcal{N}(0, \sigma^2)\) --- нормальный шум,
  влияющий на выходной сигнал \(y_i\);
  \item \(\theta = \{\theta_0, \theta_1 \}\) --- набор параметров: смещение
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.75\linewidth}{0.75\paperheight}}{Noisy_data.pdf}
    \end{center}
...
\PY{n}{Alpha} \PY{o}{=} \PY{n}{LA}\PY{o}{.}\PY{n}{solve}\PY{p}{(}\PY{n}{F}\PY{o}{.}\PY{n}{T} \PY{o}{@} \PY{n}{F}\PY{p}{,} \PY{n}{F}\PY{o}{.}\PY{n}{T} \PY{o}{@} \PY{n}{Y\PYZus{}train}\PY{p}{)}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{o}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{ms}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{data \PYZdl{}(x,y)\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{b}\PY{p}{,} \PY{n}{m}\PY{o}{+}\PY{n}{b}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{k\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}y = }\PY{l+s+si}{\PYZob{}}\PY{n}{b}\PY{l+s+si}{:}\PY{l+s+s1}{.0f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{ + }\PY{l+s+si}{\PYZob{}}\PY{n}{m}\PY{l+s+si}{:}\PY{l+s+s1}{.0f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{x\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{X\PYZus{}disp}\PY{p}{,} \PY{n}{f}\PY{p}{(}\PY{n}{X\PYZus{}disp}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{c}\PY{o}{=}\PY{n}{cm}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{n}{OLS\PYZus{}label}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.75\linewidth}{0.75\paperheight}}{LS_regression.pdf}
    \end{center}
...
\PY{c+c1}{\PYZsh{} w = scipy.linalg.solve\PYZus{}triangular(L, Fty)}
...
\PY{n}{x\PYZus{}qr} \PY{o}{=} \PY{n}{LA}\PY{o}{.}\PY{n}{solve}\PY{p}{(}\PY{n}{R}\PY{p}{,} \PY{n}{q}\PY{o}{.}\PY{n}{T} \PY{o}{@} \PY{n}{Y\PYZus{}train}\PY{p}{)}
...
\newpage
    \hypertarget{ux440ux435ux43aux443ux440ux441ux438ux432ux43dux44bux439-ux43cux43dux43a}{%
\section{Рекурсивный
МНК}\label{ux440ux435ux43aux443ux440ux441ux438ux432ux43dux44bux439-ux43cux43dux43a}}

    \hypertarget{ux43eux431ux440ux430ux449ux435ux43dux438ux435-ux431ux43bux43eux447ux43dux43eux439-ux43cux430ux442ux440ux438ux446ux44b}{%
\subsection{Обращение блочной
матрицы}\label{ux43eux431ux440ux430ux449ux435ux43dux438ux435-ux431ux43bux43eux447ux43dux43eux439-ux43cux430ux442ux440ux438ux446ux44b}}
...
\]
    ...
    \hypertarget{ux444ux43eux440ux43cux443ux43bux430-ux448ux435ux440ux43cux430ux43dux430-ux43cux43eux440ux440ux438ux441ux43eux43dux430-ux432ux443ux434ux431ux435ux440ux438-smw}{%
\subsection{Формула Шермана --- Моррисона --- Вудбери
(SMW)}\label{ux444ux43eux440ux43cux443ux43bux430-ux448ux435ux440ux43cux430ux43dux430-ux43cux43eux440ux440ux438ux441ux43eux43dux430-ux432ux443ux434ux431ux435ux440ux438-smw}}
...
%\]
    ...
    \hypertarget{ux43fux440ux438ux431ux43bux438ux436ux451ux43dux43dux430ux44f-ux444ux43eux440ux43cux443ux43bux430}{%
\subsection{Приближённая
формула}\label{ux43fux440ux438ux431ux43bux438ux436ux451ux43dux43dux430ux44f-ux444ux43eux440ux43cux443ux43bux430}}
