...
%\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_11_1.pdf}
    \end{center}
...
%\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={1.0\linewidth}{1.0\paperheight}}{output_12_0.pdf}
    \end{center}
...
%\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_26_0.pdf}
    \end{center}
