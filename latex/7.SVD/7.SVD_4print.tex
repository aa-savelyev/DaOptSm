...
разложение}\label{ux441ux43fux435ux43aux442ux440ux430ux43bux44cux43dux43eux435-ux440ux430ux437ux43bux43eux436ux435ux43dux438ux435}}
    ...
    \begin{center}
    \adjustimage{max size={0.6\linewidth}{0.6\paperheight}}{output_17_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
разложение}\label{ux441ux438ux43dux433ux443ux43bux44fux440ux43dux43eux435-ux440ux430ux437ux43bux43eux436ux435ux43dux438ux435}}
    ...
    \begin{center}
    \adjustimage{max size={0.6\linewidth}{0.6\paperheight}}{output_21_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
%    \begin{center}
%    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{output_32_1.png}
%    \end{center}
%    { \hspace*{\fill} \\}

    \begin{center}
    \adjustimage{max size={0.75\linewidth}{0.75\paperheight}}{output_33_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
%    \begin{center}
%    \adjustimage{max size={0.33\linewidth}{0.33\paperheight}}{output_37_0.png}
%    \end{center}
%    { \hspace*{\fill} \\}
    

%    \begin{center}
%    \adjustimage{max size={0.75\linewidth}{0.75\paperheight}}{output_39_0.png}
%    \end{center}
%    { \hspace*{\fill} \\}
...
%    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.8\linewidth}{0.8\paperheight}}{output_43_0.png}
    \end{center}
    { \hspace*{\fill} \\}
