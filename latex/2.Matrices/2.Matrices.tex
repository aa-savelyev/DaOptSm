...
\item
  Найти \(x\) в уравнении \(Ax = b\);
\item
  Найти \(x\) и \(\lambda\) в уравнении \(Ax = \lambda x\);
\item
  Найти \(v\), \(u\) и \(\sigma\) в уравнении \(Av = \sigma u\);
\item
  Найти минимум выражения
  \(\dfrac{\lVert Ax \rVert^2}{\lVert x \rVert^2}\);
\item
  Найти разложение матрицы \(A\).
\end{enumerate}

\begin{enumerate}
\item
  Можно ли вектор \(b\) представить в виде линейной комбинации векторов
  матрицы \(A\)?
\item
  Вектор \(Ax\) имеет то же направление, что и вектор \(x\). Вдоль этого
  направления все сложные взаимодействия с матрицей \(A\) чрезвычайно
  упрощаются. Вектор \(A^2 x\) становится просто \(\lambda^2 x\),
  матрица \(e^{At}\) --- \(e^{\lambda t}\). Все действия становятся
  линейными.
\item
  Уравнение \(Av = \sigma u\) похоже на предыдущее. Но матрица \(A\)
  больше не квадратная. Это сингулярное разложение
\item
  Минимизация и факторизация являются фундаментальными прикладными
  задачами.
\end{enumerate}

    \begin{center}\rule{0.5\linewidth}{\linethickness}\end{center}

    \hypertarget{ux443ux43cux43dux43eux436ux435ux43dux438ux435-ux43cux430ux442ux440ux438ux446-4-ux441ux43fux43eux441ux43eux431ux430}{%
\section{Умножение матриц (4
способа)}\label{ux443ux43cux43dux43eux436ux435ux43dux438ux435-ux43cux430ux442ux440ux438ux446-4-ux441ux43fux43eux441ux43eux431ux430}}

Давайте начнём с умножения матриц. \[ A \cdot B = C \]
...
Об иногда забывают, но матрицы можно умножать и по-другому. Произведение
\(AB\) равно \emph{сумме произвдений} всех столбцов матрицы \(A\) на
соотвествующий строки матрицы \(B\).
...
Посмотрим внимательном на то, как мы поличили первый столбец
результирующий матрицы. Он является суммой столбцов матрицы \(A\) с
...
следующее правило:\\
\emph{\(\mathbf{i}\)-ый столбец результирующий матрицы есть сумма всех
столбцов левой матрицы с коэффициентами из \(\mathbf{i}\)-ого столбца
правой матрицы.}
...
\emph{\(\mathbf{i}\)-ая строка результирующий матрицы есть сумма всех
строк правой матрицы с коэффициентами из \(\mathbf{i}\)-ой строки левой
матрицы.}

    \textbf{Пример 3. Умножение матрицы на вектор}

Рассмотрим умножение матрицы \(A\) размером \(l \times n\) на вектор:
\(A \mathbf{x}\).
...
\]
    ...
    \textbf{Пример 5. Умножение блочных матриц}
...
\end{enumerate}
    ...
    \hypertarget{ux43bux438ux43dux435ux439ux43dux430ux44f-ux43eux431ux43eux43bux43eux447ux43aux430-ux440ux430ux437ux43cux435ux440ux43dux43eux441ux442ux44c-ux43fux440ux43eux441ux442ux440ux430ux43dux441ux442ux432ux430-ux440ux430ux43dux433-ux43cux430ux442ux440ux438ux446ux44b}{%
\subsection{Линейная оболочка, размерность пространства, ранг
матрицы}\label{ux43bux438ux43dux435ux439ux43dux430ux44f-ux43eux431ux43eux43bux43eux447ux43aux430-ux440ux430ux437ux43cux435ux440ux43dux43eux441ux442ux44c-ux43fux440ux43eux441ux442ux440ux430ux43dux441ux442ux432ux430-ux440ux430ux43dux433-ux43cux430ux442ux440ux438ux446ux44b}}

Посмтрим ещё раз на задачу \(A \mathbf{x} = \mathbf{b}\).\\
Теперь её можно переформулировать так: ответить, можно ли столбец
...
\textbf{Определение 1.} Рангом матрицы \(A\) с \(n\) строк и \(m\)
...
виде, пользуясь правилом вмножения «столбец на столбец». Мы получлили
...
\(A = CR\), где матрицы \(C\) и \(R\) имеют размеры соттвественно
\(m \times r\) и \(r \times n\). Другое название скелетного разложения
--- ранговая факторизация.

Так как ранг произведения не превосходит рангов сомножителей, а ранги
\(C\) и \(R\) не могут быть больше \(r\), то они равны \(r\).
...
\(C\) --- базисные столбцы, \(R\) --- базисные строки. Это разложение
доказывает теорему: ранг матрицы по столбцам (количество независимых
столбцов) равен рангу матрицы по строкам (количество независимых строк).

    \textbf{Не рассказывать.}
...
матрицы \(A\), матрица \(R\) теперь состоит из \(r\) независимых строк
матрицы \(A\), а матрица \(M\) размером \(r \times r\) называется
...
матрицы на транспонированную. Полученную квадратную матрицу (в случае
если она невырожденная) можно уже домножать на обратную («делить на
матрицу»).

    \textbf{\emph{Разложение матрицы на сумму матриц ранга 1.}}

Применяем умножение «столбец на строку»: \[
  A = 
  \begin{pmatrix}
     1 & 2 & 3 \\
     2 & 1 & 3 \\
...
\]
    ...
    Вернемся к СЛАУ. Теорема Фредгольма в виде пространства столбцов,
пространства строк и в виде ядро-образ.

\textbf{``Большая картина линейной алгебры''.}
...
Ортогональные матрицы (сложим ортонормированные вектора). Пример:
вращение, отражение Симметричная матрица. Пример: ортогональная
проекция, отражение (симметричная и ортогональная одновременно?).
...
\end{enumerate}
    ...
    \hypertarget{ux437ux430ux43cux435ux447ux430ux442ux435ux43bux44cux43dux44bux435-ux43cux430ux442ux440ux438ux446ux44b}{%
\section{Замечательные
матрицы}\label{ux437ux430ux43cux435ux447ux430ux442ux435ux43bux44cux43dux44bux435-ux43cux430ux442ux440ux438ux446ux44b}}
...
\textbf{Примеры}: \(A^\top A\), матрица ортогональной проекции, матрицы
поворота и симметрии.

    \hypertarget{ux43cux430ux442ux440ux438ux446ux430-ux43eux440ux442ux43eux433ux43eux43dux430ux43bux44cux43dux43eux439-ux43fux440ux43eux435ux43aux446ux438ux438}{%
\subsection{Матрица ортогональной
проекции}\label{ux43cux430ux442ux440ux438ux446ux430-ux43eux440ux442ux43eux433ux43eux43dux430ux43bux44cux43dux43eux439-ux43fux440ux43eux435ux43aux446ux438ux438}}
...
поэтому вектор \(A\mathbf{x} - \mathbf{b}\) должен быть ортогонален
\emph{любому} вектору \(A\mathbf{y}\). Запишем это через скалярное
произведение: \[
  (A \mathbf{y})^\top(A\mathbf{x} - \mathbf{b}) = \mathbf{y}^\top (A^\top A \mathbf{x} - A^\top \mathbf{b}) = 0.
\]

Это српаведливо для произвольного вектора \(\mathbf{y}\), откуда
следует, что \[
...
Матрица \(P = A (A^\top A)^{-1} A^\top \mathbf{b}\), осуществляющая
проекцию, называется \emph{матрицей ортогонального проектирования}.
...
\end{enumerate}
    ...
    \hypertarget{ux440ux430ux437ux43bux43eux436ux435ux43dux438ux44f-ux43cux430ux442ux440ux438ux446}{%
\section{Разложения
матриц}\label{ux440ux430ux437ux43bux43eux436ux435ux43dux438ux44f-ux43cux430ux442ux440ux438ux446}}
...
\subsection{\texorpdfstring{\(\mathbf{LU}\)-разложение}{\textbackslash{}mathbf\{LU\}-разложение}}\label{mathbflu-ux440ux430ux437ux43bux43eux436ux435ux43dux438ux435}}
...
\subsubsection{Определение и критерий
...
называется разложение матрицы \(A\) в произведение \(LU\) невырожденной
нижней треугольной матрицы \(L\) и верхней треугольной матрицы \(U\) с
...
\emph{строк} матрицы \(A\) она превращается в единичную матрицу. Если
...
свободных членов), то последний столбец превартится в решение системы.
    ...
    \hypertarget{ux432ux441ux435-ux433ux43bux430ux432ux43dux44bux435-ux43cux438ux43dux43eux440ux44b-ux43eux442ux43bux438ux447ux43dux44b-ux43eux442-ux43dux443ux43bux44f}{%
\subsubsection{Все главные миноры отличны от
нуля}\label{ux432ux441ux435-ux433ux43bux430ux432ux43dux44bux435-ux43cux438ux43dux43eux440ux44b-ux43eux442ux43bux438ux447ux43dux44b-ux43eux442-ux43dux443ux43bux44f}}
...
является нижней треугольной. Тогда получаем: \[ A = LU. \]
    ...
    \hypertarget{ux441ux443ux449ux435ux441ux442ux432ux443ux44eux442-ux43dux435ux43dux443ux43bux435ux432ux44bux435-ux433ux43bux430ux432ux43dux44bux435-ux43cux438ux43dux43eux440ux44b-mathbflup-ux440ux430ux437ux43bux43eux436ux435ux43dux438ux435}{%
\subsubsection{\texorpdfstring{Существуют ненулевые главные миноры
(\(\mathbf{LUP}\)-разложение)}{Существуют ненулевые главные миноры (\textbackslash{}mathbf\{LUP\}-разложение)}}\label{ux441ux443ux449ux435ux441ux442ux432ux443ux44eux442-ux43dux435ux43dux443ux43bux435ux432ux44bux435-ux433ux43bux430ux432ux43dux44bux435-ux43cux438ux43dux43eux440ux44b-mathbflup-ux440ux430ux437ux43bux43eux436ux435ux43dux438ux435}}
...
\subsubsection{\texorpdfstring{\(\mathbf{LDU}\)-разложение}{\textbackslash{}mathbf\{LDU\}-разложение}}\label{mathbfldu-ux440ux430ux437ux43bux43eux436ux435ux43dux438ux435}}
...
единственно.\\
\textbf{Предложение 3.} \(QR\)-разложение тесно связано с процессом
ортогонализации Грама --- Шмидта. Действительно, \(AU = Q\) равносильно
\(QR\)-разложению с \(R = U^{-1}\).
...
\]
    ...
    \hypertarget{mathbfqr-ux440ux430ux437ux43bux43eux436ux435ux43dux438ux435-ux434ux43bux44f-ux43fux440ux44fux43cux43eux443ux433ux43eux43bux44cux43dux44bux445-ux43cux430ux442ux440ux438ux446}{%
\subsection{\texorpdfstring{\(\mathbf{QR}\)-разложение прямоугольных матриц}{\textbackslash{}mathbf\{QR\}-разложение прямоугольных матриц}}\label{mathbfqr-ux440ux430ux437ux43bux43eux436ux435ux43dux438ux435-ux434ux43bux44f-ux43fux440ux44fux43cux43eux443ux433ux43eux43bux44cux43dux44bux445-ux43cux430ux442ux440ux438ux446}}
...
\tightlist
\item
  G. Strang. Linear algebra and learning from data. Wellesley-Cambridge
  Press, 2019. 432 p.
\item
  Д.В. Беклемишев. Дополнительные главы линейной алгебры. М.: Наука,
  1983. 336 с.
\end{enumerate}
