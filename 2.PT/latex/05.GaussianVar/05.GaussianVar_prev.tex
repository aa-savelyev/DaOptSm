...
\PY{n}{x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{3}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{n}{num}\PY{o}{=}\PY{l+m+mi}{1001}\PY{p}{)}
...
Положительная полуопределёнонсть означает, что
\(\forall \mathbf{a} \in \mathbb{R}^n: \mathbf{a}^\top \mathbf{K} \mathbf{a} \ge 0\).
...
\item
  ...
  \]
\item
  Двумерное распределение параметров \(x_1\) и \(x_2\) положительной
  ковариацией (скоррелированые переменные): \[
  \mathcal{N}\left(
  \begin{bmatrix}
   0 \\
   0.5
...
\PY{n}{x1}\PY{p}{,} \PY{n}{x2}\PY{p}{,} \PY{n}{p} \PY{o}{=} \PY{n}{generate\PYZus{}surface}\PY{p}{(}\PY{n}{bivariate\PYZus{}mean}\PY{p}{,} \PY{n}{bivariate\PYZus{}covariance}\PY{p}{,} \PY{n}{d}\PY{p}{)}
...
\item
  ...
  \emph{независимых нормальных случайных величин};
\item
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.55\linewidth}{0.55\paperheight}}{output_39_0.png}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.65\paperheight}}{output_43_0.png}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.55\linewidth}{0.55\paperheight}}{output_45_0.png}
    \end{center}
%    { \hspace*{\fill} \\}
