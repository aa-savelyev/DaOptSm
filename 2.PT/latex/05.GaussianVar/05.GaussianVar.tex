...
Таким образом, распределение вероятностей этой случайной величины
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.75\linewidth}{0.75\paperheight}}{Gauss_1D_lines.pdf}
    \end{center}
    % { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.75\linewidth}{0.75\paperheight}}{Gauss_1D_sum.pdf}
    \end{center}
    % { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.65\paperheight}}{Gauss_2D_samples.pdf}
    \end{center}
    % { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.75\linewidth}{0.75\paperheight}}{Pearson_distribution.pdf}
    \end{center}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.65\paperheight}}{Gauss_2D_95ci.pdf}
    \end{center}
    % { \hspace*{\fill} \\}
