...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.65\paperheight}}{output_13_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.65\paperheight}}{output_16_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.95\linewidth}{0.95\paperheight}}{output_35_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\PY{n}{s} \PY{o}{=} \PY{n}{ax}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{Y}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{Y}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{o}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{c}\PY{o}{=}\PY{n}{cm}\PY{o}{.}\PY{n}{tab10}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,} \PY{n}{ms}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.55\linewidth}{0.55\paperheight}}{output_43_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.65\paperheight}}{output_47_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\PY{k}{def} \PY{n+nf}{make\PYZus{}ellipse}\PY{p}{(}\PY{n}{mu}\PY{p}{,} \PY{n}{cov}\PY{p}{,} \PY{n}{ci}\PY{o}{=}\PY{l+m+mf}{0.95}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{gray}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{label} \PY{o}{=} \PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}}\PY{l+m+mi}{100}\PY{o}{*}\PY{n}{ci}\PY{l+s+si}{:}\PY{l+s+s1}{.2g}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZpc{} ci}\PY{l+s+s1}{\PYZsq{}}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.55\linewidth}{0.55\paperheight}}{output_49_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
