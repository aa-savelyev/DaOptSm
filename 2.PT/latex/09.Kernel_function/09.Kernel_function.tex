\documentclass[11pt,a4paper]{article}
    ...
    \title{
      {\Large Лекция 9} \\
      Ковариационная функция и её параметры
    }
...
\subsection{Используемые ковариационные
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{kernels} \PY{o}{=} \PY{p}{[} \PY{n}{GP\PYZus{}kernels}\PY{o}{.}\PY{n}{gauss}\PY{p}{,} \PY{n}{GP\PYZus{}kernels}\PY{o}{.}\PY{n}{rational\PYZus{}quadratic}\PY{p}{,}
            \PY{n}{GP\PYZus{}kernels}\PY{o}{.}\PY{n}{periodic}\PY{p}{,}  \PY{n}{GP\PYZus{}kernels}\PY{o}{.}\PY{n}{brownian}\PY{p}{]}
\PY{n}{kernel\PYZus{}names} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Gauss kernel}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Rational quadratic kernel}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Periodic kernel}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Brownian kernel}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\PY{n}{kernel\PYZus{}args} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{l}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mf}{1.0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sigma\PYZus{}k}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mf}{1.0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{alpha}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{period}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mf}{4.5}\PY{p}{\PYZcb{}}
