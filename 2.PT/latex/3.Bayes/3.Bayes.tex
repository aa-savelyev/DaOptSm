...
Известно, что молекулы типов \(A\) и \(B\) в потоке частиц встречаются с
...
ложноположительной и «правдивоположительной» частей.
...
\begin{quote}
Отношение правдоподобия --- это отношение вероятности получить некоторые
данные при верной гипотезе к вероятности получить такие же данные при
неверной гипотезе.
\end{quote}
...
0.6785714285714286
    ...
    Вернёмся к экспериментом из \textbf{задачи 3}.
