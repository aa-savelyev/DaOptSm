...
\PY{n}{sigma\PYZus{}f} \PY{o}{=} \PY{l+m+mf}{1.}  \PY{c+c1}{\PYZsh{} Scale parameter of each movement}
\PY{n}{std} \PY{o}{=} \PY{n}{sigma\PYZus{}f}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{delta\PYZus{}t}\PY{p}{)}  \PY{c+c1}{\PYZsh{} Standard deviation of each movement}
...
\PY{n}{std\PYZus{}t} \PY{o}{=} \PY{n}{sigma\PYZus{}f}\PY{o}{*}\PY{n}{t}\PY{o}{*}\PY{o}{*}\PY{l+m+mf}{0.5}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{ylim}\PY{p}{(}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{3}\PY{o}{*}\PY{n}{sigma\PYZus{}f}\PY{o}{*}\PY{n}{t\PYZus{}max}\PY{o}{*}\PY{o}{*}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{l+m+mi}{3}\PY{o}{*}\PY{n}{sigma\PYZus{}f}\PY{o}{*}\PY{n}{t\PYZus{}max}\PY{o}{*}\PY{o}{*}\PY{l+m+mf}{0.5}\PY{p}{]}\PY{p}{)}
...
\PY{n}{sigma} \PY{o}{=} \PY{n}{sigma\PYZus{}f}\PY{o}{*}\PY{n}{t\PYZus{}star}\PY{o}{*}\PY{o}{*}\PY{l+m+mf}{0.5}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.65\paperheight}}{output_15_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
Параметр длины \(l\) контролирует гладкость функции, а \(\sigma\) ---
вертикальную вариацию. В многомерном случае обычно используется один и
тот же параметр длины \(l\) для всех компонент вектора \(x\) (изотропное
ядро). Могут быть определены и другие функции ядра, приводящие к
различным свойствам гауссовского процесса.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{8}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Isotropic squared exponential kernel}
\PY{k}{def} \PY{n+nf}{gauss\PYZus{}kernel}\PY{p}{(}\PY{n}{X1}\PY{p}{,} \PY{n}{X2}\PY{p}{,} \PY{n}{l}\PY{o}{=}\PY{l+m+mf}{1.0}\PY{p}{,} \PY{n}{sigma\PYZus{}f}\PY{o}{=}\PY{l+m+mf}{1.0}\PY{p}{)}\PY{p}{:}
...
\PY{l+s+sd}{        sigma\PYZus{}f: Kernel vertical variation parameter}
...
\PY{n}{Sigma} \PY{o}{=} \PY{n}{gauss\PYZus{}kernel}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X}\PY{p}{)}  \PY{c+c1}{\PYZsh{} Kernel of data points}
...
\PY{n}{X\PYZus{}strong} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{.2}\PY{p}{]}\PY{p}{,} \PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
\PY{n}{Sigma\PYZus{}strong} \PY{o}{=} \PY{n}{gauss\PYZus{}kernel}\PY{p}{(}\PY{n}{X\PYZus{}strong}\PY{p}{,} \PY{n}{X\PYZus{}strong}\PY{p}{)}
\PY{c+c1}{\PYZsh{} Select samples}
\PY{n}{X\PYZus{}00\PYZus{}index} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{isclose}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{)}\PY{p}{)}
...
\PY{c+c1}{\PYZsh{} Strong correlation}
\PY{n}{X\PYZus{}weak} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{2.}\PY{p}{]}\PY{p}{,} \PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
\PY{n}{Sigma\PYZus{}weak} \PY{o}{=} \PY{n}{gauss\PYZus{}kernel}\PY{p}{(}\PY{n}{X\PYZus{}weak}\PY{p}{,} \PY{n}{X\PYZus{}weak}\PY{p}{)}
\PY{c+c1}{\PYZsh{} Select samples}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.65\paperheight}}{output_41_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{brownian\PYZus{}kernel}\PY{p}{(}\PY{n}{X1}\PY{p}{,} \PY{n}{X2}\PY{p}{,} \PY{n}{sigma\PYZus{}f}\PY{o}{=}\PY{l+m+mf}{1.}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
...
\PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
    ...
    \PY{k}{return} \PY{n}{sigma\PYZus{}f}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2} \PY{o}{*} \PY{n}{cov}
\end{Verbatim}
\end{tcolorbox}
...
\PY{c+c1}{\PYZsh{} Set mean and covariance}
\PY{n}{sigma\PYZus{}f} \PY{o}{=} \PY{l+m+mf}{1.0}
...
\PY{n}{K} \PY{o}{=} \PY{n}{brownian\PYZus{}kernel}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{,} \PY{n}{sigma\PYZus{}f}\PY{p}{)}
...
\PY{n}{std\PYZus{}x} \PY{o}{=} \PY{n}{sigma\PYZus{}f}\PY{o}{*}\PY{n}{x}\PY{o}{*}\PY{o}{*}\PY{l+m+mf}{0.5}
\PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{8}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Процесс броуновского движения,}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}}
\PY{l+s+s1}{    траектории }\PY{l+s+si}{\PYZob{}}\PY{n}{n\PYZus{}draw}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{ реализаций процесса}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{ylim}\PY{p}{(}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{3}\PY{o}{*}\PY{n}{sigma\PYZus{}f}\PY{o}{*}\PY{n}{x\PYZus{}max}\PY{o}{*}\PY{o}{*}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{l+m+mi}{3}\PY{o}{*}\PY{n}{sigma\PYZus{}f}\PY{o}{*}\PY{n}{x\PYZus{}max}\PY{o}{*}\PY{o}{*}\PY{l+m+mf}{0.5}\PY{p}{]}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{tight\PYZus{}layout}\PY{p}{(}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
