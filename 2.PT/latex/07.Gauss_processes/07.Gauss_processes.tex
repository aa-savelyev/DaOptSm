...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Brownian_motion.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
вектора \(x\) (\textit{изотропное ядро}). Могут быть определены и другие функции
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{CovMatrix_gauss_kernel.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Samples_5x51.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Traj_examples.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{BrMo_as_GP.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
