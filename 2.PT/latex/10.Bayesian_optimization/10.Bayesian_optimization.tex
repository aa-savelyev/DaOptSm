...
Отметим, что \(I(x)\) является случайной величиной, так как \(y(x)\)
является сечением гауссовского процесса в точке \(x\) и, следовательно,
гауссовской случайной величиной с плотностью распределения
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.75\linewidth}{0.75\paperheight}}{PI.png}
    \end{center}
%    { \hspace*{\fill} \\}
...
\PY{k}{def} \PY{n+nf}{probability\PYZus{}of\PYZus{}improvement}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{xi}\PY{o}{=}\PY{l+m+mf}{0.01}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
\PY{l+s+sd}{    Probability of Improvement}
\PY{l+s+sd}{    Computes the probability of improvement at points X based on existing samples}
\PY{l+s+sd}{    X\PYZus{}train and Y\PYZus{}train using a Gaussian process surrogate model.}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Args:}
\PY{l+s+sd}{        X: Points at which PI shall be computed (m x d)}
\PY{l+s+sd}{        X\PYZus{}train: Sample locations (n x d)}
\PY{l+s+sd}{        Y\PYZus{}train: Sample values (n x 1)}
\PY{l+s+sd}{        xi: Exploitation\PYZhy{}exploration trade\PYZhy{}off parameter}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Returns:}
\PY{l+s+sd}{        Probability of improvement at points X}
\PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
    \PY{n}{mu}\PY{p}{,} \PY{n}{cov} \PY{o}{=} \PY{n}{GP\PYZus{}predictor}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,}
                           \PY{n}{kernel\PYZus{}fun}\PY{p}{,} \PY{n}{kernel\PYZus{}args}\PY{p}{,} \PY{n}{sigma\PYZus{}n}\PY{p}{)}
    \PY{n}{mu} \PY{o}{=} \PY{n}{mu}\PY{o}{.}\PY{n}{flatten}\PY{p}{(}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \hypertarget{ux442ux435ux441ux442-1.-ux434ux430ux43dux43dux44bux435-ux431ux435ux437-ux448ux443ux43cux430}{%
\section{Тест 1. Данные без
шума}\label{ux442ux435ux441ux442-1.-ux434ux430ux43dux43dux44bux435-ux431ux435ux437-ux448ux443ux43cux430}}
...
\PY{k}{def} \PY{n+nf}{plot\PYZus{}approximation}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{Y}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}next}\PY{o}{=}\PY{k+kc}{None}\PY{p}{,} \PY{n}{show\PYZus{}legend}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}Plot GP approximation\PYZsq{}\PYZsq{}\PYZsq{}}
    \PY{n}{mu}\PY{p}{,} \PY{n}{cov} \PY{o}{=} \PY{n}{GP\PYZus{}predictor}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,}
                           \PY{n}{kernel\PYZus{}fun}\PY{p}{,} \PY{n}{kernel\PYZus{}args}\PY{p}{,} \PY{n}{sigma\PYZus{}n}\PY{p}{)}
...
\PY{k}{def} \PY{n+nf}{plot\PYZus{}acquisition}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{Y}\PY{p}{,} \PY{n}{X\PYZus{}next}\PY{p}{,} \PY{n}{show\PYZus{}legend}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}Plot acquisition function\PYZsq{}\PYZsq{}\PYZsq{}}
...
\newpage
    \begin{center}
      ...
      Рисунок. Поиск оптимума, первые несколько итераций
    \end{center}
%    { \hspace*{\fill} \\}
\newpage
...
%    \begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}
    ...
    \hypertarget{ux442ux435ux441ux442-2.-ux434ux430ux43dux43dux44bux435-ux441-ux448ux443ux43cux43eux43c}{%
\section{Тест 2. Данные с
шумом}\label{ux442ux435ux441ux442-2.-ux434ux430ux43dux43dux44bux435-ux441-ux448ux443ux43cux43eux43c}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Objective function values at X\PYZus{}test}
\PY{n}{sigma\PYZus{}in} \PY{o}{=} \PY{l+m+mf}{1.0}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{plot\PYZus{}approximation\PYZus{}noisy}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{Y}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}next}\PY{o}{=}\PY{k+kc}{None}\PY{p}{,} \PY{n}{show\PYZus{}legend}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}Plot GP approximation of noisy function\PYZsq{}\PYZsq{}\PYZsq{}}
    \PY{n}{mu}\PY{p}{,} \PY{n}{cov} \PY{o}{=} \PY{n}{GP\PYZus{}predictor}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,}
                           \PY{n}{kernel\PYZus{}fun}\PY{p}{,} \PY{n}{kernel\PYZus{}args}\PY{p}{,} \PY{n}{sigma\PYZus{}n}\PY{p}{)}
    \PY{n}{std} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{diag}\PY{p}{(}\PY{n}{cov}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{flatten}\PY{p}{(}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{fill\PYZus{}between}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{flatten}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{mu}\PY{o}{.}\PY{n}{flatten}\PY{p}{(}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{std}\PY{p}{,} \PY{n}{mu}\PY{o}{.}\PY{n}{flatten}\PY{p}{(}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{std}\PY{p}{,}
...
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{N\PYZus{}budget}\PY{p}{)}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{} Plot samples, surrogate function, noise\PYZhy{}free objective and next sampling location}
    \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{n}{N\PYZus{}budget}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{i} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}
    \PY{n}{plot\PYZus{}approximation\PYZus{}noisy}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{Y\PYZus{}noisy}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}next}\PY{p}{,} \PY{n}{show\PYZus{}legend}\PY{o}{=}\PY{p}{(}\PY{n}{i}\PY{o}{==}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Iteration }\PY{l+s+si}{\PYZob{}}\PY{n}{i}\PY{o}{+}\PY{n}{N\PYZus{}init}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{, X\PYZus{}next = }\PY{l+s+si}{\PYZob{}}\PY{n}{X\PYZus{}next}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{l+s+si}{:}\PY{l+s+s1}{.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    ...
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{n}{N\PYZus{}init}\PY{p}{,} \PY{o}{*}\PY{n}{X\PYZus{}next}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{acq}\PY{p}{)}
    \PY{k}{if} \PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{acq} \PY{o}{\PYZlt{}} \PY{l+m+mf}{1e\PYZhy{}100}\PY{p}{)} \PY{o+ow}{or} \PY{p}{(}\PY{n+nb}{abs}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{X\PYZus{}train}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{\PYZlt{}} \PY{l+m+mf}{1e\PYZhy{}3}\PY{o}{*}\PY{n}{x\PYZus{}range}\PY{p}{)}\PY{p}{:}
        \PY{k}{break}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
3 [0.34] 0.21129533620479102
4 [0.606] 0.0010416820820532465
5 [0.654] 6.488911863838183e-05
6 [0.714] 0.04345838906355252
7 [0.732] 4.536539043727052e-06
8 [0.764] 3.0242845261242436e-19
9 [0.792] 1.0252693135708542e-32
10 [0.148] 1.1646530610137362e-63
11 [0.79] 3.4778694854757706e-86
12 [0.788] 6.540251505269432e-88
13 [0.788] 5.934644377829497e-125
    \end{Verbatim}
...
%\vspace{-10ex}
    \begin{center}
      ...
      Рисунок. Поиск оптимума по шумным данным, первые несколько итераций
    \end{center}
%    { \hspace*{\fill} \\}
\newpage
