...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{lower\PYZus{}bound}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{l+m+mf}{0.}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
...
предсказываемое суррогатной моделью значение в точке \(x\).
Отметим, что
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{probability\PYZus{}of\PYZus{}improvement}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{delta\PYZus{}f}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{with} \PY{n}{np}\PY{o}{.}\PY{n}{errstate}\PY{p}{(}\PY{n}{divide}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{warn}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
        \PY{n}{imp} \PY{o}{=} \PY{n}{y\PYZus{}min} \PY{o}{\PYZhy{}} \PY{n}{mu} \PY{o}{\PYZhy{}} \PY{n}{delta\PYZus{}f}
...
Получившаяся функция продвижения \(EI(x)\), называемая \emph{ожидаемым улучшением}, удачно сочетает эксплуатацию и эксплорацию и поэтому используется чаще других.
Первое слагаемое, с точностью до множителя совпадающее с вероятностью улучшения \(PI(x)\), отвечает за
эксплуатацию, второе --- за эксплорацию.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{7}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{expected\PYZus{}improvement}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{delta\PYZus{}f}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
...
\PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
    ...
    \PY{n}{mu} \PY{o}{=} \PY{n}{mu}\PY{o}{.}\PY{n}{flatten}\PY{p}{(}\PY{p}{)}
    \PY{n}{std} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{diag}\PY{p}{(}\PY{n}{cov}\PY{p}{)}\PY{p}{)}
    \PY{n}{mu\PYZus{}sample\PYZus{}opt} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{min}\PY{p}{(}\PY{n}{Y\PYZus{}train}\PY{p}{)}

    \PY{k}{with} \PY{n}{np}\PY{o}{.}\PY{n}{errstate}\PY{p}{(}\PY{n}{divide}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{warn}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
        \PY{n}{imp} \PY{o}{=} \PY{n}{mu\PYZus{}sample\PYZus{}opt} \PY{o}{\PYZhy{}} \PY{n}{mu} \PY{o}{\PYZhy{}} \PY{n}{delta\PYZus{}f}
        \PY{n}{z} \PY{o}{=} \PY{n}{imp} \PY{o}{/} \PY{n}{std}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{output_30_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{output_35_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{output_38_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\PY{c+c1}{\PYZsh{} X\PYZus{}init = np.array([0, 1., 0.75]).reshape(\PYZhy{}1, 1)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{output_42_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{output_45_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\PY{k}{def} \PY{n+nf}{plot\PYZus{}acquisition}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{Y}\PY{p}{,} \PY{n}{X\PYZus{}next}\PY{p}{,} \PY{n}{show\PYZus{}legend}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}\PYZsq{}\PYZsq{}\PYZsq{}}
    \PY{n}{Y}\PY{p}{[}\PY{n}{Y}\PY{o}{\PYZlt{}}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{0}
...
\PY{n}{N\PYZus{}budget} \PY{o}{=} \PY{l+m+mi}{20}
...
\PY{k}{def} \PY{n+nf}{acq\PYZus{}function}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{elif} \PY{n}{acqusition\PYZus{}id} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{PI}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
        \PY{k}{return} \PY{n}{probability\PYZus{}of\PYZus{}improvement}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{delta\PYZus{}f}\PY{o}{=}\PY{l+m+mf}{.5}\PY{p}{)}
    \PY{k}{elif} \PY{n}{acqusition\PYZus{}id} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{EI}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
        \PY{k}{return} \PY{n}{expected\PYZus{}improvement}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{delta\PYZus{}f}\PY{o}{=}\PY{l+m+mf}{.5}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{N\PYZus{}budget}\PY{p}{)}\PY{p}{:}   
    ...
    \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Iteration }\PY{l+s+si}{\PYZob{}}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{3}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{, X\PYZus{}next = }\PY{l+s+si}{\PYZob{}}\PY{n}{X\PYZus{}next}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{l+s+si}{:}\PY{l+s+s1}{.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    ...
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{i+3}\PY{p}{,} \PY{o}{*}\PY{n}{X\PYZus{}next}\PY{p}{,} \PY{n}{acq}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
3 [0.334] -0.3364932082568557
4 [0.226] -0.0034811521894206644
5 [0.656] -1.897859987758373e-06
6 [0.706] -9.521403257906226e-06
7 [0.77] -1.0771447983001847
8 [0.] -0.0
    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.99\paperheight}}{output_51_1.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Objective function values at X\PYZus{}test}
\PY{n}{sigma\PYZus{}in} \PY{o}{=} \PY{l+m+mf}{3.}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{output_58_0.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Choose acquisition function}
\PY{n}{acqusition\PYZus{}id} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{EI}\PY{l+s+s1}{\PYZsq{}} \PY{c+c1}{\PYZsh{} \PYZsq{}PM\PYZsq{}, \PYZsq{}PI\PYZsq{}, \PYZsq{}EI\PYZsq{}}
...
\PY{c+c1}{\PYZsh{} acquisition function}
\PY{k}{def} \PY{n+nf}{acq\PYZus{}function}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{)}\PY{p}{:}
    \PY{k}{if}   \PY{n}{acqusition\PYZus{}id} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{PM}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
        \PY{k}{return} \PY{n}{predicted\PYZus{}minimum}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{l+m+mf}{5.}\PY{p}{)}
    \PY{k}{elif} \PY{n}{acqusition\PYZus{}id} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{PI}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
        \PY{k}{return} \PY{n}{probability\PYZus{}of\PYZus{}improvement}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{delta\PYZus{}f}\PY{o}{=}\PY{l+m+mf}{.5}\PY{p}{)}
    \PY{k}{elif} \PY{n}{acqusition\PYZus{}id} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{EI}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
        \PY{k}{return} \PY{n}{expected\PYZus{}improvement}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{delta\PYZus{}f}\PY{o}{=}\PY{l+m+mf}{.5}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Initialize samples}
\PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{seed}\PY{p}{(}\PY{l+m+mi}{142}\PY{p}{)}
\PY{n}{X\PYZus{}train} \PY{o}{=} \PY{n}{X\PYZus{}init}
...
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{N\PYZus{}budget}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{Y\PYZus{}next\PYZus{}true} \PY{o}{=} \PY{n}{f\PYZus{}obj}\PY{p}{(}\PY{n}{X\PYZus{}next}\PY{p}{)}
    
    \PY{c+c1}{\PYZsh{} Plot samples, surrogate function, noise\PYZhy{}free objective and next sampling location}
    \PY{k}{if} \PY{o+ow}{not} \PY{p}{(}\PY{n}{i} \PY{o}{\PYZpc{}} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{:}
        \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{n}{N\PYZus{}budget}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{n}{i} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}
        ...
        \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{n}{N\PYZus{}budget}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{n}{i} \PY{o}{+} \PY{l+m+mi}{2}\PY{p}{)}
        \PY{n}{Y\PYZus{}acq} \PY{o}{=} \PY{n}{acq\PYZus{}function}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{)}
        \PY{n}{plot\PYZus{}acquisition}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{Y\PYZus{}acq}\PY{p}{,} \PY{n}{X\PYZus{}next}\PY{p}{,} \PY{n}{show\PYZus{}legend}\PY{o}{=}\PY{p}{(}\PY{n}{i}\PY{o}{==}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}
    ...
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{i+3}\PY{p}{,} \PY{o}{*}\PY{n}{X\PYZus{}next}\PY{p}{,} \PY{n}{acq}\PY{p}{)}
    \PY{k}{if} \PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{acq} \PY{o}{\PYZlt{}} \PY{l+m+mf}{1e\PYZhy{}200}\PY{p}{)} \PY{o+ow}{or} \PY{p}{(}\PY{n+nb}{abs}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{X\PYZus{}next}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{\PYZlt{}} \PY{l+m+mf}{1e\PYZhy{}3}\PY{o}{*}\PY{n}{x\PYZus{}range}\PY{p}{)}\PY{p}{:}
        \PY{k}{break}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
3 [0.268] -0.7204088466535097
4 [0.184] -0.003387667466214453
5 [0.144] -0.00013247955846280727
6 [0.668] -1.5605284086420157e-07
7 [0.696] -1.0696690392936377e-06
8 [0.626] -3.202580005652315e-14
9 [0.774] -1.3695032938691717e-52
10 [0.8] -1.780609393522457e-23
11 [0.8] -2.9518213813069516e-65
    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.99\paperheight}}{output_65_1.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
