...
\PY{k}{def} \PY{n+nf}{set\PYZus{}constants}\PY{p}{(}\PY{n}{obj\PYZus{}fun}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{fun\PYZus{}name} \PY{o}{=} \PY{n}{obj\PYZus{}fun}\PY{o}{.}\PY{n+nv+vm}{\PYZus{}\PYZus{}name\PYZus{}\PYZus{}}
    \PY{k}{if} \PY{n}{fun\PYZus{}name} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ParSin}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
    ...
    \PY{k}{elif} \PY{n}{fun\PYZus{}name} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{rosen}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
    ...
    \PY{k}{else}\PY{p}{:}
        \PY{k}{raise} \PY{n+ne}{ValueError}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Unknown objective function: }\PY{l+s+s2}{\PYZsq{}}\PY{l+s+si}{\PYZob{}}\PY{n}{fun\PYZus{}name}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    
    \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{X\PYZus{}LIM}\PY{p}{)}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{F\PYZus{}LIM}\PY{p}{)}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{X\PYZus{}OPT}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
случай}\label{ux43eux434ux43dux43eux43cux435ux440ux43dux44bux439-ux441ux43bux443ux447ux430ux439}}
    ...
    \textbf{Парабола \(\times\) синус (ParSin)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{obj\PYZus{}fun} \PY{o}{=} \PY{n}{ParSin}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{sigma\PYZus{}n} \PY{o}{=} \PY{l+m+mf}{1.0}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{obj\PYZus{}fun} \PY{o}{=} \PY{n}{rosen}
\PY{n}{X\PYZus{}LIM}\PY{p}{,} \PY{n}{F\PYZus{}LIM}\PY{p}{,} \PY{n}{X\PYZus{}OPT} \PY{o}{=} \PY{n}{set\PYZus{}constants}\PY{p}{(}\PY{n}{obj\PYZus{}fun}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.9\paperheight}}{Rosenbrock.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
\PY{k}{def} \PY{n+nf}{add\PYZus{}noise}\PY{p}{(}\PY{n}{fun}\PY{p}{,} \PY{n}{sigma\PYZus{}n}\PY{p}{)}\PY{p}{:}
    \PY{k}{def} \PY{n+nf}{ret\PYZus{}fun}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
        \PY{n}{xi} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{randn}\PY{p}{(}\PY{p}{)}
        \PY{k}{return} \PY{n}{fun}\PY{p}{(}\PY{n}{x}\PY{p}{)} \PY{o}{+} \PY{n}{sigma\PYZus{}n} \PY{o}{*} \PY{n}{xi}
    \PY{k}{return} \PY{n}{ret\PYZus{}fun}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{fun\PYZus{}contours}\PY{p}{(}\PY{n}{obj\PYZus{}fun\PYZus{}noisy}\PY{p}{,} \PY{n}{points}\PY{o}{=}\PY{p}{[}\PY{n}{X\PYZus{}OPT}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.9\paperheight}}{Rosenbrock_noise.pdf}
    \end{center}
%    { \hspace*{\fill} \\}
...
Провести сравнение двух методов построения суррогатных моделей:
полиномиальная регрессия (PR) и регрессия на основе гауссовских
процессов (GPR). Рассмотреть два случая: одномерный (функция ParSin) и
двумерный (функция Розенброка).
...
\item
  Сделать план экспериментов, рекомендуется использовать метод LHS из
  библиотеки \texttt{pyDOE2} или \texttt{DOEpy}.
\item
  Построить суррогатные модели методами: PR и GPR. Количество признаков
  для полиномиальной регрессии выбрать самостоятельно.
\item
  Построить зависимость ошибки по норме \(L_2\) от количества точек в
  обучающей выборке \(N_{train}\) (1D: \(N_{train, 1D} = [4, 8, 16]\),
  2D: \(N_{train, 2D} = [8, 16, 32]\)). Ошибку считать по методу
  кросс-валидации.
\item
  Повторить процедуру для данных с шумом \(\sigma_n = 1.0\).
\end{enumerate}
