...
# <div class="toc"><ul class="toc-item"><li><span><a href="#Введение" data-toc-modified-id="Введение-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Введение</a></span><ul class="toc-item"><li><span><a href="#Превращение-мира-в-набор-данных" data-toc-modified-id="Превращение-мира-в-набор-данных-1.1"><span class="toc-item-num">1.1&nbsp;&nbsp;</span>Превращение мира в набор данных</a></span></li><li><span><a href="#Четвёртая-парадигма" data-toc-modified-id="Четвёртая-парадигма-1.2"><span class="toc-item-num">1.2&nbsp;&nbsp;</span>Четвёртая парадигма</a></span></li></ul></li><li><span><a href="#Числовые-характеристики-выборки-и-представление-данных" data-toc-modified-id="Числовые-характеристики-выборки-и-представление-данных-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>Числовые характеристики выборки и представление данных</a></span><ul class="toc-item"><li><span><a href="#Числовые-характеристики" data-toc-modified-id="Числовые-характеристики-2.1"><span class="toc-item-num">2.1&nbsp;&nbsp;</span>Числовые характеристики</a></span><ul class="toc-item"><li><span><a href="#Показатели-положения-центра-распределения" data-toc-modified-id="Показатели-положения-центра-распределения-2.1.1"><span class="toc-item-num">2.1.1&nbsp;&nbsp;</span>Показатели положения центра распределения</a></span></li><li><span><a href="#Разброс-распределения-данных" data-toc-modified-id="Разброс-распределения-данных-2.1.2"><span class="toc-item-num">2.1.2&nbsp;&nbsp;</span>Разброс распределения данных</a></span></li><li><span><a href="#Взаимосвязи-между-переменными" data-toc-modified-id="Взаимосвязи-между-переменными-2.1.3"><span class="toc-item-num">2.1.3&nbsp;&nbsp;</span>Взаимосвязи между переменными</a></span></li></ul></li><li><span><a href="#Визуализация" data-toc-modified-id="Визуализация-2.2"><span class="toc-item-num">2.2&nbsp;&nbsp;</span>Визуализация</a></span><ul class="toc-item"><li><span><a href="#Квартет-Энскомба" data-toc-modified-id="Квартет-Энскомба-2.2.1"><span class="toc-item-num">2.2.1&nbsp;&nbsp;</span>Квартет Энскомба</a></span></li><li><span><a href="#Диаграммы-Каиро" data-toc-modified-id="Диаграммы-Каиро-2.2.2"><span class="toc-item-num">2.2.2&nbsp;&nbsp;</span>Диаграммы Каиро</a></span></li></ul></li></ul></li><li><span><a href="#Вероятность-—-язык-неопределённости-и-случайности" data-toc-modified-id="Вероятность-—-язык-неопределённости-и-случайности-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>Вероятность — язык неопределённости и случайности</a></span></li><li><span><a href="#Объединяем-вероятность-и-статистику" data-toc-modified-id="Объединяем-вероятность-и-статистику-4"><span class="toc-item-num">4&nbsp;&nbsp;</span>Объединяем вероятность и статистику</a></span></li><li><span><a href="#Разное" data-toc-modified-id="Разное-5"><span class="toc-item-num">5&nbsp;&nbsp;</span>Разное</a></span></li><li><span><a href="#Источники" data-toc-modified-id="Источники-6"><span class="toc-item-num">6&nbsp;&nbsp;</span>Источники</a></span></li></ul></div>
# -
...
display(Image('./pix/1.Intro/Unstructured.png', width=0.66*im_width))

display(Image('./pix/1.Intro/Anscombe.png', width=0.66*im_width))
...
plt.plot(prob_1, '-', c=cm(0), label='1 cube')
plt.plot(prob_2, '-', c=cm(1), label='2 cubes')
