...
# **Определение.** Функция, определённая на пространстве элементарных исходов, называется случайной величиной.
