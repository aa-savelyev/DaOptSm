...
# <div class="toc"><ul class="toc-item"><li><span><a href="#Введение" data-toc-modified-id="Введение-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Введение</a></span><ul class="toc-item"><li><span><a href="#Превращение-мира-в-набор-данных" data-toc-modified-id="Превращение-мира-в-набор-данных-1.1"><span class="toc-item-num">1.1&nbsp;&nbsp;</span>Превращение мира в набор данных</a></span></li><li><span><a href="#Преподавание-статистики" data-toc-modified-id="Преподавание-статистики-1.2"><span class="toc-item-num">1.2&nbsp;&nbsp;</span>Преподавание статистики</a></span></li></ul></li><li><span><a href="#Расчёт-долей:-качественные-данные-и-проценты" data-toc-modified-id="Расчёт-долей:-качественные-данные-и-проценты-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>Расчёт долей: качественные данные и проценты</a></span><ul class="toc-item"><li><span><a href="#Представление-результатов" data-toc-modified-id="Представление-результатов-2.1"><span class="toc-item-num">2.1&nbsp;&nbsp;</span>Представление результатов</a></span></li></ul></li><li><span><a href="#Числовые-характеристики-выборки-и-представление-данных" data-toc-modified-id="Числовые-характеристики-выборки-и-представление-данных-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>Числовые характеристики выборки и представление данных</a></span><ul class="toc-item"><li><span><a href="#Числовые-характеристики" data-toc-modified-id="Числовые-характеристики-3.1"><span class="toc-item-num">3.1&nbsp;&nbsp;</span>Числовые характеристики</a></span><ul class="toc-item"><li><span><a href="#Показатели-положения-центра-распределения" data-toc-modified-id="Показатели-положения-центра-распределения-3.1.1"><span class="toc-item-num">3.1.1&nbsp;&nbsp;</span>Показатели положения центра распределения</a></span></li><li><span><a href="#Разброс-распределения-данных" data-toc-modified-id="Разброс-распределения-данных-3.1.2"><span class="toc-item-num">3.1.2&nbsp;&nbsp;</span>Разброс распределения данных</a></span></li><li><span><a href="#Взаимосвязи-между-переменными" data-toc-modified-id="Взаимосвязи-между-переменными-3.1.3"><span class="toc-item-num">3.1.3&nbsp;&nbsp;</span>Взаимосвязи между переменными</a></span></li></ul></li></ul></li><li><span><a href="#Вероятность-—-язык-неопределённости-и-случайности" data-toc-modified-id="Вероятность-—-язык-неопределённости-и-случайности-4"><span class="toc-item-num">4&nbsp;&nbsp;</span>Вероятность — язык неопределённости и случайности</a></span></li><li><span><a href="#Объединяем-вероятность-и-статистику" data-toc-modified-id="Объединяем-вероятность-и-статистику-5"><span class="toc-item-num">5&nbsp;&nbsp;</span>Объединяем вероятность и статистику</a></span></li><li><span><a href="#Литература" data-toc-modified-id="Литература-6"><span class="toc-item-num">6&nbsp;&nbsp;</span>Литература</a></span></li></ul></div>
# -
...
#
# > К ВВП Великобритании в 2014 году были отнесены торговля наркотиками и проституция.
#
...
#
# Цикл **PPDAC** (Problem, Plan, Data, Analysis, Conclusion).
#
# 1. Первая стадия цикла &mdash; определение *проблемы*: статистичекое исследование всегда начинается с вопроса.
# 2. Искушение пренебречь необходимостью в хорошем *плане* довольно велико.
# 3. Сбор *данных* требует определённых организаторских навыков и навыков кодирования. Данные из некоторых источников могут нуждаться в тщательной очистке перед их анализом. Само выражение &laquo;найти данные&raquo; указывает на то, что данные бывают довольно грязными.
# 4. В курсах статистики основной упор делается на стадию *анализа*, однако иногда всё, что необходимо сделать на данном этапе, &mdash; это наглядная визуализация (**книга по визуализации**).
# 5. Наконец, главное в статистической науке &mdash; сделать соответствующие *заключения*. Заключения, как правило, приводят к новым вопросам, поэтому цикл начинается заново.
#  
# На практике цикл PPDAC может не соблюдаться с абсолютной точностью, но он подчеркивает, что формальные методы статистического анализа &mdash; это только часть работы специалиста по обработке данных.
#

# ---

# ## Расчёт долей: качественные данные и проценты ##
#
# ### Представление результатов ###
#
# **Фрейминг**
#
# Классическим примером того, как фрейминг меняет эмоциональное восприятие какого-нибудь показателя, стали плакаты, появившиеся в 2011 году в лондонском метро, которые гласили, что "99 % молодых лондонцев не воершают серьёзных насильственных преступлений".
# Предполагалось, что такие заявления будут способствовать спокойствию пассажиров.
#
# Изменение эмоционального воздействия:
#
# 1. Переход от позитива к негативу: 1 % молодых лондонцев совершают серьёзные насильственные преступления.
# 1. Переход от процентной доли а фактическое количество: в Лондоне проживает 10 тысяч агрессивно настроенных молодых людей.
#
# В идеале нужно давать как положительные, так и отрицательные значения, хотя даже порядок столбцов в таблице может влиять на интерпретацию.
# СМИ любят рейтинговые таблицы, однако они могут вводить в заблуждение: различия бывают вызваны случайными отклонениями, больницы принимают пациентов с заболеваниями разной степени тяжести.
#
# **Выбор нуля**
#
# Данные можно представить в виде горизонтальной столбчатой диаграммы.
# Главное --- решить, где начинать горизонтальную ось.
# Если с 0 %, то полосы займут практически всю ширину диаграммы и их трудно будет различить.
# Если с 95 %, то все больницы будут резко отличаться, даже если на самом деле разница в показателях объясняется чистой случайностью.
#
# Следовательно, выбор начала оси представляет собой дилемму.
# Хороший выбор --- начинать с "логической и взвешенной точки отсчёта". которую однако бывает трудно определить.
#
# Психологи всё активнее изучают воздействие различных форматов числовых и графических данных на наше восприятие.
# Коммуникации --- важная часть цикла решения проблем, и она не должна зависеть от личных предпочтений.
